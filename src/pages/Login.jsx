...
function Login() {
  ...
  return (
    <section className='flex flex-col justify-center mx-auto py-4 min-h-screen bg-gray-50 dark:bg-gray-900'>
      <div className='px-4 mx-auto max-w-screen-xl lg:py-16 grid lg:grid-cols-2 gap-8 lg:gap-16'>
        <div className='flex flex-col justify-center'>
          <h1 className='items-center text-center mb-4 text-4xl font-extrabold tracking-tight leading-none text-gray-900 md:text-5xl lg:text-6xl dark:text-white'>
            <img src='/Marvel_Comics_(2000).svg' alt='Marvel logo' className='justify-center mx-auto w-2/4 mb-3' />
            Marvel Comics
          </h1>
          <p className='text-center mb-6 text-xl font-normal min-h-max text-gray-500 lg:text-xl dark:text-gray-400'>
            Aqui puedes explorar comics de Marvel y saber mas sobre ellos.
          </p>
        </div>
        <div>
          <div className='w-full lg:max-w-xl p-6 space-y-8 sm:p-8 bg-white rounded-lg shadow-xl dark:bg-gray-800'>
            ...
            <form className='mt-8 space-y-6' action='#' onSubmit={login}>
              ...
              <div className='text-right text-md font-medium text-gray-900 dark:text-white'>
                ¿No estas registrado?{' '}
